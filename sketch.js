...
function setup() {
 ...
 console.log(message)
  ...
  gameOver = createSprite(displayWidth/2-350,displayHeight-900);
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(displayWidth/2-350,displayHeight-750);
...
function draw() {
  ...
  //displaying score
  textSize(20)
  text("Score: "+ score, displayWidth-20,displayHeight+0);
  ...
  if(gameState === PLAY){
    ...
    if(keyDown("space")&& trex.y >= 100) {
        trex.velocityY = -12;
        jumpSound.play();
        camera.position.y = trex.position.y - 20;
